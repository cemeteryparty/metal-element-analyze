...
model.save(base_path + f"mymodel/MyModel-front{model_name}.h5py")

""" Revise the effect of label's regularization """
def RC_Net_T(Shape = (64, 64, 1)):
	front_model = load_model(base_path + f"mymodel/MyModel-front{model_name}.h5py")
...
model_t.save(base_path + f"mymodel/MyModel-end{model_name}.h5py")