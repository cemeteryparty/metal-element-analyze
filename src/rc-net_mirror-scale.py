...
def RC_Net(Shape = (64, 64, 3)):
	...
	# outputs = Multiply()([outputs, np.array([100.0, 1000.0, 1000.0]).reshape(1, 3)])
...
def RC_Net_MS(Shape = (64, 64, 1)):
	front_model = load_model(base_path + f"mymodel/RC-Net_front.h5py")
	...
	return Model(inputs = inputs, outputs = outputs, name = "RC-Net_ms")
model_t = RC_Net_MS(Shape = (128, 128, 3))
model_t.summary()
...
model_t.save(base_path + f"mymodel/RC-Net_ms.h5py")